...
#SBATCH -t 4:00:00
#SBATCH -A standby
#SBATCH -o ML_NH3_1C_Angew-1+H_minimized_optimized_r3.slurm.out
#SBATCH -e ML_NH3_1C_Angew-1+H_minimized_optimized_r3.slurm.err
...
cd /depot/bsavoie/data/Lin/perov_ML_lin/mono/MD_sims/Pb_I_cubic/NH3_1C_Angew-1+H_minimized_optimized/run3
echo Working directory is /depot/bsavoie/data/Lin/perov_ML_lin/mono/MD_sims/Pb_I_cubic/NH3_1C_Angew-1+H_minimized_optimized/run3
